    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2023 - Favrite Ordering System <a href="https://web.facebook.com/favritehideout" target="_blank">Favrite</a></div></div>
        </footer>
